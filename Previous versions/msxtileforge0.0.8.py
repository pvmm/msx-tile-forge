...
class TileEditorApp:
    ...
    def create_tile_editor_widgets(self, parent_frame):
        ...
        # Left Column: Editor, Attributes, and NEW Transform Buttons
        ...
        editor_frame.grid(row=0, column=0, pady=(0, 10), sticky="ew") # Stick horizontally maybe
        ...
        # Attribute Editor (Row 1)
        attr_frame = ttk.LabelFrame(left_frame, text="Row Colors (Click to set FG/BG)")
        attr_frame.grid(row=1, column=0, pady=(0,10), sticky="ew") # Stick horizontally
        self.attr_row_frames = []
        self.attr_fg_labels = []
        self.attr_bg_labels = []
        for r in range(TILE_HEIGHT):
            # ... (Attribute row setup remains the same) ...
        ...
        # Right Column: Palette and Tileset Viewer (remains the same)
